...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    // Default to dark class; ThemeProvider will adjust on client based on localStorage
    <html lang="en" suppressHydrationWarning className="dark" data-theme="dark">
      <body className="antialiased min-h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-main)]">
        <ThemeProvider>
          <I18nProvider>
            <AuthProvider>
              <Navbar />
